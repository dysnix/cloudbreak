...
//!
//! It is purely diagnostic: it emits logs/metrics (corroborating `discrepancy`)
//! and never creates or drops anything. Off unless `explain-enabled = true`.

use crate::modules::identity::{CAP_TABLE, IndexIdentity};
